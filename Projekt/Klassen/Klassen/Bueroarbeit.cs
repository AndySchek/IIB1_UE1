...
namespace Klassen
{
    ...
    public class Bueroarbeit : Raum
    {
        ...
        public Bueroarbeit(double flaeche, double brandgefahr, String bezeichnung, Feuerloescher feuerloescher) : base(flaeche, brandgefahr, bezeichnung, feuerloescher) { TypRaume = typRaum; }
